...
public class JwtUtil {
    ...
    private static final String SECRET = "phambuituanthanhsecretkeyhahahahahahahahahahahahahahahahahahahahahahaha";

    public String generateToken(UserPrincipal user) {
        String token = null;
        try {
            JWTClaimsSet.Builder builder = new JWTClaimsSet.Builder();
            builder.claim(USER, user); // Nhet UserPrincipal vao Payload
